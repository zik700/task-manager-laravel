...
<body>
  ...
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm">
        ...
        <div class="lh-100">
            <h6 class="mb-0 text-white lh-100">Hi, {{ $user->name }}!</h6>
  ...
  <div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    @foreach($tasks as $task)
     <div class="media text-muted pt-3">
          ...
          <span class="d-block">to: {{ $user->name }}</span>
          <span class="d-block">deadline: <strong>{{ $task->deadline }}</strong></span>
          <span class="d-block">description: <strong>{{ $task->description }}</strong></span>
          </div>
     </div> 
